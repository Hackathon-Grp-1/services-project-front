...
const skeuoShadow =
  "0 6px 24px 0 rgba(60,60,60,0.18), 0 1.5px 4px 0 rgba(255,255,255,0.7) inset";
  ...
  useEffect(() => {
    ...
    const handleMouseMoveTrail = (e: MouseEvent) => {
      ...
      spot.style.transition =
        "opacity 0.18s cubic-bezier(0.4,0,0.2,1), left 0.12s linear, top 0.12s linear"; // transition plus rapide et fluide pour la position
      spot.style.backgroundImage =
        "radial-gradient(circle at center, var(--color-secondary) 0%, var(--color-accent) 30%, rgba(90,200,250,0.18) 60%, rgba(30,42,56,0.08) 100%)";
  ...
  return (
    <Box
      sx={{
        minHeight: "100vh",
        bgcolor:
          "linear-gradient(135deg, #7B61FF 0%, #5AC8FA 40%, #F7B267 100%)",
        ...
        >
          ...
          <Container maxWidth="md" sx={{ position: "relative", zIndex: 2 }}>
            ...
            >
              ...
              <Typography
                variant="h5"
                sx={{ mb: 4, opacity: 0.95, textShadow: "0 1px 4px #e3e6ed" }}
              >
      ...
      <Fade direction="up" triggerOnce cascade damping={0.18}>
        <Container maxWidth="lg" sx={{ py: { xs: 6, md: 10 } }}>
          <Typography
            variant="h3"
            align="center"
            sx={{ fontWeight: 700, mb: 4, textShadow: "0 1px 4px #e3e6ed" }}
          >
                ...
                >
                  <VerifiedUserIcon
                    ...
                    sx={{
                      fontSize: 54,
                      mb: 1,
                      filter: "drop-shadow(0 2px 8px #e3e6ed)",
                    }}
                  />
                  <Typography
                    variant="h4"
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Paiement sécurisé via escrow, facturation automatisée, aucun
                    coût d'inscription ou d'abonnement.
                  </Typography>
                </Paper>
              </Zoom>
            </Box>
            <Box sx={{ flex: { xs: "1", md: "0 1 45%" } }}>
              <Zoom triggerOnce delay={200}>
                ...
                >
                  ...
                  <Divider sx={{ my: 2, borderColor: "#e0e3ea" }} />
                  <Typography variant="body2" color="text.secondary">
                    Frais cachés, gestion manuelle, peu de garanties sur la
                    réussite du projet.
                  </Typography>
                </Paper>
              </Zoom>
      ...
      <Fade direction="up" triggerOnce cascade damping={0.18}>
        <Container maxWidth="md" sx={{ py: { xs: 2, md: 4 } }}>
          <Typography
            variant="h4"
            align="center"
            sx={{ fontWeight: 700, mb: 3, textShadow: "0 1px 4px #e3e6ed" }}
          >
            FAQ Tarifs
          </Typography>
          <Zoom triggerOnce cascade damping={0.18}>
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  Non, la commission SMP (4-8%) est la seule retenue. Aucun
                  frais d'inscription, d'abonnement ou de gestion caché.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  Le paiement est bloqué sur un compte escrow (Stripe) et libéré
                  uniquement à la validation du projet, pour une sécurité totale
                  des deux parties.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            >
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography fontWeight={600}>
                  La commission varie-t-elle selon le projet ?
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                  Oui, elle dépend du volume et de la nature du projet : 4% pour
                  les gros volumes, 8% pour les missions ponctuelles. Un devis
                  personnalisé est possible.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
            ...
            >
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography fontWeight={600}>
                  Puis-je obtenir un devis précis avant de démarrer ?
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography>
                  Oui, contactez-nous pour une simulation gratuite et
                  transparente adaptée à vos besoins.
                </Typography>
              </AccordionDetails>
            </Accordion>
          </Zoom>
          ...
          <Zoom triggerOnce>
            ...
            >
              ...
              >
                <Box sx={{ flex: { xs: "1", sm: "1" } }}>
                  ...
                  >
                    ...
                    <Typography
                      variant="h4"
                      sx={{ fontWeight: 700, color: "secondary.main", my: 1 }}
                    >
                      8% commission
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      Pour les projets <b>inférieurs à 10 000€</b> ou missions
                      courtes.
                    </Typography>
                    <Divider sx={{ my: 2, borderColor: "#e0e3ea" }} />
                    <Typography variant="body2" color="text.secondary">
                      Exemple : pour un projet de 5 000 €, la commission SMP est
                      de 400 € (vous payez 5 400 € tout compris).
                    </Typography>
                  </Paper>
                </Box>
                <Box sx={{ flex: { xs: "1", sm: "1" } }}>
                  ...
                  >
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Pour les projets <b>supérieurs à 10 000€</b> ou clients
                      récurrents.
                    </Typography>
                    <Divider sx={{ my: 2, borderColor: "#e0e3ea" }} />
                    <Typography variant="body2" color="text.secondary">
                      Exemple : pour un projet de 25 000 €, la commission SMP
                      est de 1 000 € (vous payez 26 000 € tout compris).
                    </Typography>
                  </Paper>
                </Box>
              </Box>
              ...
              <Typography variant="body2" color="text.secondary" align="center">
                Pour une estimation personnalisée, contactez-nous :{" "}
                <a
        ...
        >
          <Zoom triggerOnce>
            ...
            >
              <Typography
                variant="h4"
                sx={{ fontWeight: 700, mb: 2, textShadow: "0 1px 4px #e3e6ed" }}
              >
                Prêt à profiter de la tarification la plus juste ?
              </Typography>
              <Typography variant="h6" sx={{ mb: 4, opacity: 0.95 }}>
                Rejoignez SMP Platform et réalisez vos projets en toute
                confiance.
              </Typography>
              <Button
                variant="contained"
